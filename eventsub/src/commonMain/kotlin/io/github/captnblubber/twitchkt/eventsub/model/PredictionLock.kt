...
/**
 * [Twitch EventSub: channel.prediction.lock](https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelpredictionlock)
 *
 ...
 * @property lockedAt RFC3339 timestamp of when the prediction was locked.
 */
data class PredictionLock(
