...
/**
 * [Twitch EventSub: channel.channel_points_custom_reward.update](https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelchannel_points_custom_rewardupdate)
 *
 * Fired when a custom channel points reward is updated. Uses the same structure as
 * [ChannelPointsCustomRewardAdd].
 */
data class ChannelPointsCustomRewardUpdate(
