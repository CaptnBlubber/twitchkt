...
/**
 * [Twitch EventSub: channel.goal.begin](https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelgoalbegin)
 *
 ...
 * @property type the goal type (e.g. `follower`, `subscription`, `subscription_count`, `new_subscription`, `new_subscription_count`).
