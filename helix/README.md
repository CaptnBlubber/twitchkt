...
- `twitchkt-core` (API) — config, auth contracts, errors
- Ktor client (HTTP, content negotiation, serialization)
- `kotlinx-coroutines-core` — Flow-based pagination

## Structure

```
helix/src/
├── commonMain/kotlin/io/github/captnblubber/twitchkt/helix/
│   ├── TwitchHelix.kt
...
│   │   ├── ChatResource.kt
│   │   ├── ClipResource.kt
│   │   ├── ExtensionResource.kt
│   │   ├── FollowerResource.kt
│   │   ├── GameResource.kt
│   │   ├── GoalResource.kt
│   │   ├── HypeTrainResource.kt
│   │   ├── ModerationResource.kt
│   │   ├── PollResource.kt
│   │   ├── PredictionResource.kt
│   │   ├── RaidResource.kt
│   │   ├── RewardResource.kt
│   │   ├── ScheduleResource.kt
│   │   ├── SearchResource.kt
│   │   ├── StreamResource.kt
│   │   ├── SubscriptionResource.kt
│   │   ├── TeamResource.kt
│   │   ├── UserResource.kt
│   │   ├── VideoResource.kt
│   │   └── WhisperResource.kt
│   └── model/              — 50+ request/response models
├── commonTest/              — Unit tests (scope validation, HTTP client, resources, models)
